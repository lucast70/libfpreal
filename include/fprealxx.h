...
protected:
  // get the data
  inline uint_t getData () const noexcept {
    return data;
  }
...
inline fpreal_t operator+(const double b, fpreal_t &a) {
  return a + b;
}
inline fpreal_t operator+(const std::string b, fpreal_t &a) {
  return a + b;
}
inline fpreal_t operator+(const char *b, fpreal_t &a) {
  return a + b;
}
inline fpreal_t operator-(const double b, fpreal_t &a) {
  return a - b;
